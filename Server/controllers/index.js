...
export const addData = async (req, res) => {
    try {
      ...
      // Create a new instance of the reportModel with the provided data
      const newData = new reportModel({ end_year, intensity, sector, topic, insight, url, region, start_year, impact, added, published, country, relevance, pestle, source, title, likelihood });
