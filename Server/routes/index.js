...
import { filteredByAny, filteredByCountry, filteredByIntensity, filteredByLikelihood, filteredByPestle, filteredByRegion, filteredBySector, filteredBySource, filteredByTitle, filteredByTopic, filteredByYear, getAllData ,addData} from '../controllers/index.js';

//creating a router
const router = express.Router();

router.post('/abc', addData);
